...
cmake_dependent_option(BUILD_XERCESC "Build xercesc library source code from submodule instead of searching it in system libraries." ON "ENABLE_XERCESC" OFF)
		...
		elseif(APPLE)
			if(IOS)
				...
				if(CMAKE_OSX_DEPLOYMENT_TARGET VERSION_GREATER_EQUAL 26)
						set(DARWIN "darwin24")
						message(STATUS "Darwin version: ${CMAKE_OSX_DEPLOYMENT_TARGET} osx => ${DARWIN}")
	...
	function(add_openh264)
		...
		elseif(APPLE)
			if(IOS)
				if(CMAKE_SYSTEM_PROCESSOR STREQUAL "aarch64")
					if(PLATFORM STREQUAL "Simulator")
						set(EP_ADDITIONAL_MAKE_OPTIONS "OS=\"ios\" ARCH=\"arm64\" SDKTYPE=\"iPhoneSimulator\"")
					else()
						set(EP_ADDITIONAL_MAKE_OPTIONS "OS=\"ios\" ARCH=\"arm64\" SDKTYPE=\"iPhoneOS\"")
					endif()
...
if(BUILD_ONNXRUNTIME)
	function(add_onnxruntime)
		...
		ExternalProject_Add(onnxruntime-ep
			...
			PATCH_COMMAND sed -i [[s/CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 13.1 AND NOT(APPLE)/CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 13.1 AND NOT(APPLE)/]] onnxruntime_mlas.cmake
			CMAKE_ARGS
