...
if(BUILD_ONNXRUNTIME)
	function(add_onnxruntime)
		...
		CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS 16)
			find_program(ORT_GCC NAMES gcc-13 gcc-12 gcc-11)
			find_program(ORT_GXX NAMES g++-13 g++-12 g++-11)
			if(ORT_GCC AND ORT_GXX)
				list(APPEND ORT_EXTRA_ARGS "-DCMAKE_C_COMPILER=${ORT_GCC}" "-DCMAKE_CXX_COMPILER=${ORT_GXX}")
			endif()
		endif()
