...
if(NOT ENABLE_FAT_BINARY AND EXISTS "${LINPHONE_WRAPPER_SWIFT}")
	...
	set(SWIFT_PACKAGE_DIR "${CMAKE_CURRENT_BINARY_DIR}/swift-linphone-sdk-${SWIFT_PACKAGE_TARGET}")
	...
	foreach(XCFRAMEWORK ${XCFRAMEWORKS})
		...
		execute_process(
			COMMAND "zip" "-r" "-y" "${SWIFT_PACKAGE_DIR}/XCFrameworks/${XCFRAMEWORK_NAME}.zip" "${XCFRAMEWORK}"
			WORKING_DIRECTORY "${LINPHONESDK_BUILD_DIR}"
		)
		list(APPEND XCFRAMEWORKS_NAMES "\"${TARGET_NAME}\"")
		if (SWIFT_PACKAGE_URL_ROOT)
			execute_process(
