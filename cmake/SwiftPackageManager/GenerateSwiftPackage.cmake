...
if(NOT ENABLE_FAT_BINARY AND EXISTS "${LINPHONE_WRAPPER_SWIFT}")
	...
	set(SWIFT_PACKAGE_DIR "${CMAKE_CURRENT_BINARY_DIR}/linphone-sdk-swift-${SWIFT_PACKAGE_TARGET}-${LINPHONESDK_VERSION}")
	...
	foreach(XCFRAMEWORK ${XCFRAMEWORKS})
		...
		if (SWIFT_PACKAGE_XCFRAMEWORKS_BASE_URL)
			execute_process(
			...
			.binaryTarget(
				name: \"${TARGET_NAME}\",
				path: \"${SWIFT_PACKAGE_XCFRAMEWORKS_BASE_URL}/${LINPHONESDK_NAME}-${LINPHONESDK_VERSION}/XCFrameworks/${XCFRAMEWORK_NAME}.zip\",
