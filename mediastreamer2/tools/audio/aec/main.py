...
if __name__ == "__main__":
    ...
    speech_16kHz = input_data_path + "farend_simple_talk.wav"
    speech_48kHz = input_data_path + "farend_simple_talk_48kHz.wav"
    noise_medium_48kHz = input_data_path + "echo_4_linux_medium_noise_1min_48kHz.wav"
    noise_increasing_48kHz = input_data_path + "echo_8_linux_inscreasing_noise_1min_48kHz.wav"
    white_noise_48kHz = input_data_path + "white_noise_48000Hz.wav"
    ...
    noise_suppression_test_list = [
        # "talk_with_very_slight_noise_48kHz",
        # "talk_with_slight_noise_48kHz",
        # "talk_with_real_noise_48kHz_1",
        # "talk_with_real_noise_48kHz_2",
        # "talk_with_medium_noise_48kHz",
        "talk_with_increasing_noise_48kHz_rnnoise",
        # "talk_with_white_noise_48kHz_1_rnnoise",
        # "talk_with_white_noise_48kHz_5_rnnoise",
        # "talk_with_white_noise_48kHz_6_rnnoise",
        # "talk_with_white_noise_48kHz_7_rnnoise",
        # "talk_with_white_noise_48kHz_2_rnnoise",
        # "talk_with_white_noise_48kHz_3_rnnoise",
        # "talk_with_white_noise_48kHz_4_rnnoise",
    ]
    ...
    for test_name in noise_suppression_test_list:
        ...
        for i in range(0, 1):
            ...
            # for model in ["mswebrtcns"]:
                ...
                executable_path = os.path.join("/home/flore/Dev/Linphone-sdk/submodules_removed/linphone-sdk/out/build/default-ninja", "bin",
                ...
                speech = speech_48kHz
                noise = noise_medium_48kHz
                if "increasing" in test_name:
                    kwargs["start analysis"] = 11000
                    speech = speech_48kHz
                    noise = noise_increasing_48kHz
                elif "talk_with_white_noise" in test_name:
                    kwargs["start analysis"] = 6000
                    noise = white_noise_48kHz
                else:
            ...
            #     print("no input mic file")
                ...
                if not only_run:
                    ...
                    ns_test.files.set_file(speech, noise)
