...
#define MS_TRANSCRIPT_ENABLE MS_FILTER_METHOD(MS_TRANSCRIPT_ID, 3, bool_t *)
#define MS_TRANSCRIPT_FILE_DURATION MS_FILTER_METHOD(MS_TRANSCRIPT_ID, 4, int *)
#define MS_TRANSCRIPT_SET_CHUNK_DURATION MS_FILTER_METHOD(MS_TRANSCRIPT_ID, 5, float *)
#define MS_TRANSCRIPT_SET_OVERLAP_DURATION MS_FILTER_METHOD(MS_TRANSCRIPT_ID, 6, float *)
#define MS_TRANSCRIPT_SET_AUDIO_STREAM MS_FILTER_METHOD(MS_TRANSCRIPT_ID, 7, AudioStream *)
